...
#ATHLETE
@athlete_1 = Athlete.new('first_name' => "David", 'last_name' => "Haye", 'date_of_birth' => "1986-12-05", 'gender' => "male", 'image' => "", 'nation_id' => @nation_1.id)
@athlete_1.save()
@athlete_2 = Athlete.new('first_name' => "Paul", 'last_name' => "Pogba", 'date_of_birth' => "1993-03-15", 'gender' => "male", 'image' => "", 'nation_id' => @nation_2.id)
@athlete_2.save()
@athlete_3 = Athlete.new('first_name' => "Mario", 'last_name' => "Matt", 'date_of_birth' => "1979-04-09", 'gender' => "male", 'image' => "", 'nation_id' => @nation_3.id)
@athlete_3.save()
@athlete_4 = Athlete.new('first_name' => "Bertie", 'last_name' => "Croll", 'date_of_birth' => "1987-08-21", 'gender' => "male", 'image' => "", 'nation_id' => @nation_1.id)
@athlete_4.save()
...
@athlete_9.save()
@athlete_10 = Athlete.new('first_name' => "Kim", 'last_name' => "Yuna", 'date_of_birth' => "1990-09-05", 'gender' => "female", 'image' => "", 'nation_id' => @nation_6.id)
@athlete_10.save()
...
@athlete_28.save()
@athlete_29 = Athlete.new('first_name' => "James", 'last_name' => "Bond", 'date_of_birth' => "1968-04-13", 'gender' => "male", 'image' => "", 'nation_id' => @nation_1.id)
@athlete_29.save()
