...
#NATIONS
@nation_1 = Nation.new('name' => "Great Britain", 'region' => "Europe", 'points' => 0)
@nation_1.save()
@nation_2  = Nation.new('name' => "France", 'region' => "Europe", 'points' => 0)
@nation_2 .save()
@nation_3  = Nation.new('name' => "Austria", 'region' => "Europe", 'points' => 0)
@nation_3 .save()
@nation_4  = Nation.new('name' => "U.S.A", 'region' => "North America", 'points' => 0)
@nation_4 .save()
@nation_5  = Nation.new('name' => "China", 'region' => "Asia", 'points' => 0)
@nation_5 .save()
@nation_6  = Nation.new('name' => "South Korea", 'region' => "Asia", 'points' => 0)
@nation_6 .save()
@nation_7  = Nation.new('name' => "Canada", 'region' => "North America", 'points' => 0)
@nation_7 .save()
@nation_8  = Nation.new('name' => "Sweden", 'region' => "Europe", 'points' => 0)
@nation_8 .save()
@nation_9  = Nation.new('name' => "Italy", 'region' => "Europe", 'points' => 0)
@nation_9 .save()
@nation_10  = Nation.new('name' => "Japan", 'region' => "Asia", 'points' => 0)
@nation_10.save()
...
@event_3.save()
@event_4 = Event.new('name' => "Individual", 'class' => "female", 'score_method' => "points", 'sport_id' => @sport_2.id)
@event_4.save()
@event_5 = Event.new('name' => "Individual", 'class' => "male", 'score_method' => "time", 'sport_id' => @sport_3.id)
@event_5.save()
@event_6 = Event.new('name' => "Individual", 'class' => "female", 'score_method' => "time", 'sport_id' => @sport_3.id)
@event_6.save()
@event_7 = Event.new('name' => "1500M", 'class' => "male", 'score_method' => "time", 'sport_id' => @sport_4.id)
@event_7.save()
@event_8 = Event.new('name' => "500M", 'class' => "male", 'score_method' => "time", 'sport_id' => @sport_4.id)
@event_8.save()
@event_9 = Event.new('name' => "Normal Hill Individual", 'class' => "female", 'score_method' => "points", 'sport_id' => @sport_5.id)
@event_9.save()
@event_10 = Event.new('name' => "Large Hill Individual", 'class' => "male", 'score_method' => "points", 'sport_id' => @sport_5.id)
@event_10.save()
@event_11 = Event.new('name' => "Half-Pipe", 'class' => "female", 'score_method' => "points", 'sport_id' => @sport_6.id)
@event_11.save()
@event_12 = Event.new('name' => "Slope-Style", 'class' => "female", 'score_method' => "points", 'sport_id' => @sport_6.id)
@event_12.save()
@event_13 = Event.new('name' => "Singles", 'class' => "male", 'score_method' => "time", 'sport_id' => @sport_7.id)
@event_13.save()
...
@result_3.save()
@result_4 = Result.new('score' => "0:1:35.500", 'athlete_id' => @athlete_6.id, 'contest_id' => @contest_2.id)
@result_4.save()
