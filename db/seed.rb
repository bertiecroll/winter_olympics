...
@athlete_4.save()
@athlete_5 = Athlete.new('first_name' => "Wolfgang", 'last_name' => "Mozart", 'date_of_birth' => "1956-01-27", 'gender' => "male", 'image' => "", 'nation_id' => @nation_3.id)
@athlete_5.save()
@athlete_6 = Athlete.new('first_name' => "Tom", 'last_name' => "Hanks", 'date_of_birth' => "1956-07-09", 'gender' => "male", 'image' => "", 'nation_id' => @nation_4.id)
@athlete_6.save()
@athlete_7 = Athlete.new('first_name' => "Hillary", 'last_name' => "Clinton", 'date_of_birth' => "1947-10-26", 'gender' => "female", 'image' => "", 'nation_id' => @nation_4.id)
@athlete_7.save()
@athlete_8 = Athlete.new('first_name' => "Jackie", 'last_name' => "Chan", 'date_of_birth' => "1956-04-07", 'gender' => "male", 'image' => "", 'nation_id' => @nation_5.id)
@athlete_8.save()
@athlete_9 = Athlete.new('first_name' => "Li", 'last_name' => "Na", 'date_of_birth' => "1982-02-26", 'gender' => "female", 'image' => "", 'nation_id' => @nation_5.id)
@athlete_9.save()
@athlete_10 = Athlete.new('first_name' => "Kim", 'last_name' => "Yu Na", 'date_of_birth' => "1990-09-05", 'gender' => "female", 'image' => "", 'nation_id' => @nation_6.id)
@athlete_10.save()
@athlete_11 = Athlete.new('first_name' => "Jae-sang", 'last_name' => "Park", 'date_of_birth' => "1977-12-31", 'gender' => "male", 'image' => "", 'nation_id' => @nation_6.id)
@athlete_11.save()
@athlete_12 = Athlete.new('first_name' => "Justin", 'last_name' => "Bieber", 'date_of_birth' => "1994-03-01", 'gender' => "male", 'image' => "", 'nation_id' => @nation_7.id)
@athlete_12.save()
@athlete_13 = Athlete.new('first_name' => "Rachel", 'last_name' => "McAdams", 'date_of_birth' => "1978-11-17", 'gender' => "female", 'image' => "", 'nation_id' => @nation_7.id)
@athlete_13.save()
@athlete_14 = Athlete.new('first_name' => "Peter", 'last_name' => "Stormare", 'date_of_birth' => "1953-08-27", 'gender' => "male", 'image' => "", 'nation_id' => @nation_8.id)
@athlete_14.save()
@athlete_15 = Athlete.new('first_name' => "Malin", 'last_name' => "Akerman", 'date_of_birth' => "1978-05-12", 'gender' => "female", 'image' => "", 'nation_id' => @nation_8.id)
@athlete_15.save()
@athlete_16 = Athlete.new('first_name' => "Antonio", 'last_name' => "Conte", 'date_of_birth' => "1969-07-31", 'gender' => "male", 'image' => "", 'nation_id' => @nation_9.id)
@athlete_16.save()
@athlete_17 = Athlete.new('first_name' => "Marisa", 'last_name' => "Tomei", 'date_of_birth' => "1964-12-04", 'gender' => "female", 'image' => "", 'nation_id' => @nation_9.id)
@athlete_17.save()
@athlete_18 = Athlete.new('first_name' => "Keisuke", 'last_name' => "Honda", 'date_of_birth' => "1986-06-13", 'gender' => "male", 'image' => "", 'nation_id' => @nation_10.id)
@athlete_18.save()
@athlete_19 = Athlete.new('first_name' => "Chiaki", 'last_name' => "Kuriyama", 'date_of_birth' => "1984-10-10", 'gender' => "female", 'image' => "", 'nation_id' => @nation_10.id)
@athlete_19.save()
@athlete_20 = Athlete.new('first_name' => "Coco", 'last_name' => "Chanel", 'date_of_birth' => "1990-02-14", 'gender' => "female", 'image' => "", 'nation_id' => @nation_2.id)
@athlete_20.save()
@athlete_21 = Athlete.new('first_name' => "Lionel", 'last_name' => "Messi", 'date_of_birth' => "1987-06-24", 'gender' => "male", 'image' => "", 'nation_id' => @nation_11.id)
@athlete_21.save()
@athlete_22 = Athlete.new('first_name' => "Eva", 'last_name' => "Peron", 'date_of_birth' => "1985-07-07", 'gender' => "female", 'image' => "", 'nation_id' => @nation_11.id)
@athlete_22.save()
@athlete_23 = Athlete.new('first_name' => "Anderson", 'last_name' => "Silva", 'date_of_birth' => "1975-04-14", 'gender' => "male", 'image' => "", 'nation_id' => @nation_12.id)
@athlete_23.save()
@athlete_24 = Athlete.new('first_name' => "Gisele", 'last_name' => "Bundchen", 'date_of_birth' => "1980-07-20", 'gender' => "female", 'image' => "", 'nation_id' => @nation_12.id)
@athlete_24.save()
@athlete_25 = Athlete.new('first_name' => "Heidi", 'last_name' => "Klum", 'date_of_birth' => "1973-06-01", 'gender' => "female", 'image' => "", 'nation_id' => @nation_13.id)
@athlete_25.save()
@athlete_26 = Athlete.new('first_name' => "David", 'last_name' => "Hasselhoff", 'date_of_birth' => "1952-06-17", 'gender' => "male", 'image' => "", 'nation_id' => @nation_13.id)
@athlete_26.save()
@athlete_27 = Athlete.new('first_name' => "Bjork", 'last_name' => "Gudmundsdottir", 'date_of_birth' => "1965-11-21", 'gender' => "female", 'image' => "", 'nation_id' => @nation_14.id)
@athlete_27.save()
@athlete_28 = Athlete.new('first_name' => "Eidur", 'last_name' => "Gudjohnsen", 'date_of_birth' => "1978-09-15", 'gender' => "male", 'image' => "", 'nation_id' => @nation_14.id)
@athlete_28.save()
@athlete_29 = Athlete.new('first_name' => "Daniel", 'last_name' => "Craig", 'date_of_birth' => "1968-03-02", 'gender' => "male", 'image' => "", 'nation_id' => @nation_1.id)
@athlete_29.save()
@athlete_30 = Athlete.new('first_name' => "Vincent", 'last_name' => "Cassel", 'date_of_birth' => "1966-11-23", 'gender' => "male", 'image' => "", 'nation_id' => @nation_2.id)
@athlete_30.save()
@athlete_31 = Athlete.new('first_name' => "Arnold", 'last_name' => "Schwarzenegger", 'date_of_birth' => "1947-07-30", 'gender' => "male", 'image' => "", 'nation_id' => @nation_3.id)
@athlete_31.save()
@athlete_32 = Athlete.new('first_name' => "Dwanye", 'last_name' => "Johnson", 'date_of_birth' => "1972-05-02", 'gender' => "male", 'image' => "", 'nation_id' => @nation_4.id)
@athlete_32.save()
@athlete_33 = Athlete.new('first_name' => "Vincent", 'last_name' => "Kavinsky", 'date_of_birth' => "1992-06-24", 'gender' => "male", 'image' => "", 'nation_id' => @nation_2.id)
@athlete_33.save()
@athlete_34 = Athlete.new('first_name' => "kanye", 'last_name' => "West", 'date_of_birth' => "1977-06-08", 'gender' => "male", 'image' => "", 'nation_id' => @nation_4.id)
@athlete_34.save()
