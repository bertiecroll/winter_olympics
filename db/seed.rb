...
#NATIONS
@nation_1 = Nation.new('name' => "Great Britain", 'region' => "Europe", 'gold' => 0, 'silver' => 0, 'bronze' => 0)
@nation_1.save()
...
@nation_3 .save()
@nation_4  = Nation.new('name' => "U.S.A", 'region' => "North America", 'gold' => 0, 'silver' => 0, 'bronze' => 0)
@nation_4 .save()
@nation_5  = Nation.new('name' => "China", 'region' => "Asia", 'gold' => 0, 'silver' => 0, 'bronze' => 0)
@nation_5 .save()
@nation_6  = Nation.new('name' => "South Korea", 'region' => "Asia", 'gold' => 0, 'silver' => 0, 'bronze' => 0)
@nation_6 .save()
